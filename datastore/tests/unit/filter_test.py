...
import pytest
from gcloud.aio.datastore import (CompositeFilter, CompositeFilterOperator, Filter, PropertyFilter,
                                  PropertyFilterOperator, Value)
...
class TestFilter:
    ...
    def property_filters():
        # type: () -> typing.List[PropertyFilter]
        return [
            PropertyFilter(
                prop='prop1',
    ...
    def _assert_is_correct_prop_dict_for_property_filter(prop_dict, property_filter):
        # type: (typing.Dict[str, typing.Any], PropertyFilter) -> None
