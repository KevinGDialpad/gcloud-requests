...
class BaseQuery:
    ...
    def from_repr(cls, data):
        # type: (typing.Dict[str, typing.Any]) -> BaseQuery
...
class Query(BaseQuery):
    ...
    def __init__(self,
                 ...
                 order=None,         # type: typing.List[PropertyOrder]
    ...
    @classmethod
    def from_repr(cls, data):
        # type: (typing.Dict[str, typing.Any]) -> Query
...
class GQLQuery(BaseQuery):
    ...
    def __init__(self,
                 ...
                 named_bindings=None,      # type: typing.Dict[str, typing.Any]
                 positional_bindings=None  # type: typing.List[typing.Any]
                 ):
        # type: (...) -> None
    ...
    @classmethod
    def from_repr(cls, data):
        # type: (typing.Dict[str, typing.Any]) -> GQLQuery
...
class QueryResultBatch:
    ...
    def __init__(self,
                 ...
                 entity_results=None,  # type: typing.List[EntityResult]
                 more_results=MoreResultsType.UNSPECIFIED,   # type: MoreResultsType
    ...
    @classmethod
    def from_repr(cls, data):
        # type: (typing.Dict[str, typing.Any]) -> QueryResultBatch
